...
function appendRefundList(xhr){
		...
		if (xhr.result == false) {
			...
			list.forEach(function(item) {
				...
				contents4 = '<div><span class="date">' + item.lLeasedate
						+ '</span><span class="date">' + contents0
						+ '</span></div>';
				contents5 = '<span class="more-type2">' +"예약취소"
