                        ...
                        reader.onload = function() {
                            ...
                            img.onload = function() {
                            	 console.log(imgFile.id);
                                    //상세 이미지9(S-DS-TYPE2) or 메인 섬네일(MS),상세 섬네일(S-DS-TYPE1)에 따라 이름 붙여지는게 다름
                ...
                $(function() {
                    ...
                    $('#go').on('click', function() {
                        ...
                        $.ajax({
                            ...
                            cache: false,
                            timeout: 600000,
                            url: '/openkitchen/mypage' + '/multipartUpload',
                            data: formData,
                    ...
                    $('#addHash').click(function() {
                        if ($(".hashTxt").length < 3) {
                            if ($('.hashText').val() == '') {
                                ...
                                $('#hashField').append(
                                    '<input type="text" class="hashTxt"  name="txt" readonly="readonly" value=#' + $('.hashText').val() + '><button type="button" class="delHash"><img src="../img/icon/ico-search_del.png" alt=""></button>'
                                ); // end append
                                $(".hashText").val('');
