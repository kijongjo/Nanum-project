...
<div id="teacherSpace">
	...
	<section class="checkboxSection">
		...
		<div class="checkboxWrap" id="WrapWidth3">
			<div class="checkbox">
				<!--공간대여안함-->
				<input type="radio" name="rental" id="norental" checked="checked">
	...
	<div>
		...
		<form action="in" id="uploadForm" enctype="multipart/form-data"
			method="post">

			<!-- 공간 테마 선택란 -->
			<div class="inp-wrap">
				<span>공간 테마</span> <select name="sTema" id="">
					<option value="선택">선택</option>
					<option value="요리스튜디오">요리스튜디오</option>
					<option value="레스토랑">레스토랑</option>
					<option value="베이킹스튜디오">베이킹스튜디오</option>
			...
			<!-- 공간명,공간한줄설명,해시태그 선택란  -->
			<div class="inp-wrap">
				<span>공간명</span> <input type="text" name="sName" id=""
					placeholder="공간 명을 입력해 주세요">
			</div>
			<div class="inp-wrap">
				<span>공간 한 줄 설명<span id="placeEx-counter">0 / 45</span> <input
	...
	<!--  -->
	<a href="in"> <input type="button" value="다음" id="btn-norental" /></a>
</div>
